...
function s.e1filter(c) return c:IsSetCard(SET_EVIL_HERO) and c:IsMonster() and c:HasLevel() and not c:IsCode(id) and c:IsAbleToGrave() end
...
function s.e1op(e, tp, eg, ep, ev, re, r, rp)
    ...
    local tc = Utility.SelectMatchingCard(HINTMSG_TOGRAVE, tp, s.e1filter, tp, LOCATION_HAND + LOCATION_DECK, 0, 1, 1, nil):GetFirst()
