...
s.listed_names = {900007003}

function s.e1filter1(c) return (c:IsRace(RACE_DRAGON) or c:IsAttribute(ATTRIBUTE_DARK)) and c:IsDiscardable() end

function s.e1filter2(c, e, tp) return c:IsCode(900007003) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false) end
