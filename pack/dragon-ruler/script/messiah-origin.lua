...
function s.me2filter1(c, e, tp)
    return c:IsDiscardable() and c:IsRace(RACE_DRAGON) and
               Duel.IsExistingMatchingCard(s.me2filter2, tp, LOCATION_DECK + LOCATION_HAND, 0, 1, nil, c:GetAttribute(), e, tp)
end
...
function s.me2op(e, tp, eg, ep, ev, re, r, rp)
    ...
    local g = Utility.SelectMatchingCard(HINTMSG_SPSUMMON, tp, s.me2filter2, tp, LOCATION_DECK + LOCATION_HAND, 0, 1, 1, nil, attr, e, tp)
