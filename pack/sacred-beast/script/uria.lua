...
function s.spfilter1(c) return c:IsFaceup() and c:IsTrap() and c:IsAbleToGraveAsCost() end

function s.spfilter2(c) return c:IsTrap() and c:IsAbleToGraveAsCost() end
