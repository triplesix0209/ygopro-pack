...
s.listed_series = {SET_STARDUST, SET_JUNK}
...
function s.e1filter(c) return c:IsFaceup() and (c:IsSetCard(SET_STARDUST) or c:IsSetCard(SET_JUNK)) end
...
function s.e2filter(c) return c:IsFaceup() and c:HasLevel() and (c:IsSetCard(SET_STARDUST) or c:IsSetCard(SET_JUNK)) end
