...
function s.initial_effect(c)
    ...
    local nodiseff = Effect.CreateEffect(c)
    nodiseff:SetType(EFFECT_TYPE_FIELD)
    nodiseff:SetCode(EFFECT_CANNOT_DISEFFECT)
    nodiseff:SetRange(LOCATION_MZONE)
    nodiseff:SetTargetRange(1, 0)
    nodiseff:SetValue(function(e, ct)
