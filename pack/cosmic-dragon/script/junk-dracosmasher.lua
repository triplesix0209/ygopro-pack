...
s.listed_series = {SET_SYNCHRON, SET_JUNK}

function s.initial_effect(c)
    c:EnableReviveLimit()

    -- synchro summon
    Synchro.AddProcedure(c, function(c, sc, stype, tp) return c:IsSetCard(SET_SYNCHRON, sc, stype, tp) or c:IsHasEffect(20932152) end,
    ...
    matcheck:SetValue(function(e, c)
        ...
        if g:IsExists(Card.IsSetCard, 1, nil, SET_JUNK) then
            e:SetLabel(1)
