...
function s.e1filter(c) return c:IsFaceup() and c:IsSetCard(SET_EVIL_HERO) and c:HasLevel() end
...
function s.e2filter(c) return not c:IsCode(id) and (c:IsCode(CARD_DARK_FUSION) or c:ListsCode(CARD_DARK_FUSION)) and c:IsAbleToHand() end
