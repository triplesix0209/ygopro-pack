...
function s.spfilter1(c) return c:IsFaceup() and c:GetType() == TYPE_SPELL + TYPE_CONTINUOUS and c:IsAbleToGraveAsCost() end

function s.spfilter2(c) return s.spfilter1(c) or (c:IsFacedown() and c:IsSpell() and c:IsAbleToGraveAsCost()) end
