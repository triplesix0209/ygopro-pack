...
function s.e1dmgfilter(c) return c:IsSetCard(SET_EVIL_HERO) and c:IsMonster() end

function s.e1spfilter(c, e, tp)
    return c:IsSetCard(SET_EVIL_HERO) and c:IsMonster() and (c:IsAbleToHand() or c:IsCanBeSpecialSummoned(e, 0, tp, false, false))
end
